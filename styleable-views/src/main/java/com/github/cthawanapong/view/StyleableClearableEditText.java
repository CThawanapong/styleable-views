...
public class StyleableClearableEditText extends StyleableEditText implements View.OnTouchListener, View.OnFocusChangeListener, StyleableTextWatcherAdapter.StyleableTextWatcherListener {
    ...
    private void init() {
        ...
        addTextChangedListener(new StyleableTextWatcherAdapter(this, this));
        initIcon();
        setClearIconVisible(false);
    }
    ...
    private void initIcon() {
        ...
        if (xD == null) {
            xD = ContextCompat.getDrawable(getContext(), R.drawable.ic_cancel_text_input);
        }
    ...
    protected void setClearIconVisible(boolean visible) {
        ...
        if (visible != wasVisible) {
            ...
            TextViewCompat.setCompoundDrawablesRelativeWithIntrinsicBounds(this, (loc == Location.LEFT) ? x : cd[0], cd[1], (loc == Location.RIGHT) ? x : cd[2],
                    cd[3]);
        }
    }
